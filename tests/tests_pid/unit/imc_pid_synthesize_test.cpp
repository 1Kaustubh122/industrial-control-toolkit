...
int main(){
    ...
    [[maybe_unused]] auto o1 = synthesize(in);
    ...
    [[maybe_unused]] auto o2 = synthesize(in);
    assert(o2.Kp < o1.Kp);
    assert(o2.Ki < o1.Ki);
    ...
    in.lambda = 2.0;
    in.theta = 2.0;
    [[maybe_unused]] auto o3 = synthesize(in);
    assert(o3.Kd > o1.Kd);
    ...
    [[maybe_unused]] auto o4 = synthesize(in2); // effectively uses λ≈max(1.0, 0.004)=1.0
    ...
    [[maybe_unused]] auto o5 = synthesize(in3);
